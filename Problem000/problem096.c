 ...
 * Source: http://odz.sakura.ne.jp/projecteuler/index.php?cmd=read&page=Problem%2096
 * 
 * Problem 96 「数独」  †
 ...
 * 解は "projecteuler.net/project/images/p096_2.png" を url
 * 欄にコピーしてリターンキーを押す（ダブルクオートの中身）
 * うまく作られている"数独"パズルは,
