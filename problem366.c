 ...
 * Source: http://odz.sakura.ne.jp/projecteuler/index.php?cmd=read&page=Problem%20366
 * 
 * Problem 366 「石取りゲーム その3」  †
 ...
 * ここで先手は残りの3個の石をすべて取ることはできない, なぜなら 2x1=2, 最大2個の石しか取れないからである.
 * 先手は1個石を取ると残りは2個になる. 後手は残りの2個の石を取ることができ, 勝者となる.
 ...
 * n≤10&sup{18}; のときの ΣM(n) を求め, 10&sup{8};を法として答えよ.
 */
...
int main() {
    printf("Project Euler - Problem 366\n");
