 ...
 * Source: http://odz.sakura.ne.jp/projecteuler/index.php?cmd=read&page=Problem%20185
 * 
 * Problem 185 「Number Mind」  †
 * Number Mind は, 有名なゲームMaster Mindの変種である.
 * 色つきのペグの代わりに, 秘密の数字を推理する. 推理するごとに, 正しい桁がいくつあったかのみが伝えられる. つまり, 答えが1234で,
 * 2036と推理した場合, 1つの桁が正しいと伝えられる. 数字は正しいが場所が違うということは伝えられない.
 * 例えば, 以下の5桁の推理では,
 * 90342 ;2 桁正しい
 * 70794 ;0 桁正しい
 * 39458 ;2 桁正しい
...
int main() {
    printf("Project Euler - Problem 185\n");
