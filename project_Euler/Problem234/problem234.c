 ...
 * Source: http://odz.sakura.ne.jp/projecteuler/index.php?cmd=read&page=Problem%20234
 * 
 * Problem 234 「半分割可能数」  †
 * 整数n(≥4)に対して, 最大の素数(≤√n)を n の"下位素数平方根"(lower prime square root)とし,
 * lps(n)であらわす.
...
int main() {
    printf("Project Euler - Problem 234\n");
